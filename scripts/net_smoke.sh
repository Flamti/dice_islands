...
# Сценарий 2 (этапы 2–3): партия двух людей — барьер PhaseReady, таймеры фаз,
# у каждого участника свой остров с наложенной сеткой.
set -euo pipefail
...
echo "OK: сетевые смоук-тесты пройдены (лобби этапа 1, партия этапа 2)"
